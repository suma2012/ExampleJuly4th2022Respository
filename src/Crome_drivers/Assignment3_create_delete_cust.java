...
public class Assignment3_create_delete_cust 
{
	...
	public static void launchbrowser()
	{
		try
		{
			System.setProperty("webdriver.chrome.driver","C:\\Gitrespository\\Demoworkspace\\Web_automation\\Library\\Drivers\\chromedriver.exe");
	...
	private static void createCustomer()
	{
		try
		{
			...
			oDriver.findElement(By.id("customerLightBox_nameField")).sendKeys("suma1");
